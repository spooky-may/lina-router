...
Integra LINA Router con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de LINA Router desde el [dashboard](https://lina-router.com/dashboard)
- LINA Router ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de LINA Router
...
```json
{
  "models": [
    {
      "title": "LINA Router - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "LINA Router - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "LINA Router - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "LINA Router - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de LINA Router
...
```json
{
  "models": [
    {
      "title": "LINA Router - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que LINA Router esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de LINA Router
...
- Verifica la latencia de red hacia LINA Router
