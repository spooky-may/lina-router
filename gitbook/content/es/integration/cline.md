...
Integra LINA Router con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de LINA Router.
...
Establece la URL base a tu endpoint de LINA Router:

**Para LINA Router local:**
```
http://localhost:20128/v1
```

**Para LINA Router en la nube:**
```
https://lina-router.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de LINA Router
...
3. La key debe comenzar con `sk-lina-router-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de LINA Router
...
4. Cline usará LINA Router para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando LINA Router
...
3. Obtén explicaciones potenciadas por IA a través de LINA Router

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará LINA Router para entender el contexto y hacer cambios
...
2. Verifica que tu instancia de LINA Router esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de LINA Router para cualquier error
...
1. En la configuración de Cline, establece Base URL a: `https://lina-router.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de LINA Router
...
## Integración con características de LINA Router

### Enrutamiento de modelos

LINA Router enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, LINA Router automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de LINA Router:
