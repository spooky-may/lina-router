...
Problemas comunes y soluciones al usar LINA Router.
...
1. **Refresh automático (por defecto):**
   LINA Router refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Causas:**
- LINA Router no está ejecutándose
- Puerto 20128 bloqueado
- Firewall bloqueando la conexión

**Soluciones:**

1. **Inicia LINA Router:**
   ```bash
   lina-router
   ```
...
1. **Verifica si LINA Router está ejecutándose:**
   ```bash
   # Verifica el proceso
