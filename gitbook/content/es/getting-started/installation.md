...
- ✅ Comando simple: `lina-router`
- ✅ Auto-actualizaciones con `npm update -g lina-router`
...
3. Se crea el directorio de datos en `~/.lina-router`
...
**Ubicación por defecto:** `~/.lina-router`
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con lina-router
```
...
- **Sitio web**: [lina-router.com](https://lina-router.com)
