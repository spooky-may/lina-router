...
Những câu hỏi phổ biến về LINA Router.

---

## LINA Router là gì?

**LINA Router là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**LINA Router dùng chiến lược pricing 3 tầng:**
...
## LINA Router có miễn phí không?

**Có, LINA Router hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của LINA Router.**
...
**LINA Router theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host LINA Router không?

**Có! LINA Router hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.lina-router`)
...
**Có, LINA Router ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.lina-router` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server LINA Router
...
## Làm thế nào để cập nhật LINA Router?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/lina-router/blob/main/CHANGELOG.md)
- Backup `~/.lina-router` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/lina-router/blob/main/CONTRIBUTING.md) để biết chi tiết.
