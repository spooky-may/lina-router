...
Tích hợp LINA Router với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- LINA Router API key từ [dashboard](https://lina-router.com/dashboard)
- LINA Router đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model LINA Router
...
3. Chọn model LINA Router ưa thích
...
- Kiểm tra LINA Router đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến LINA Router
