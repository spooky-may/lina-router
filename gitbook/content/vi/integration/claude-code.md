...
Tích hợp LINA Router với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của LINA Router.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model LINA Router:
