...
LINA Routerに関する一般的な質問。

---

## LINA Routerとは?

**LINA Routerは、サブスクリプションの価値を最大化し、コストを最小限に抑えるAIモデルルーターです。**
...
**はい、LINA Router自体は100%無料でオープンソースです。**
...
**LINA Routerはすべてのプロバイダーのクォータをリアルタイムで追跡します:**
...
## LINA Routerをセルフホストできますか?

**はい! LINA Routerは複数のデプロイメントオプションをサポートします:**
...
**はい、LINA Routerはセキュリティとプライバシーを優先します:**

**ローカルストレージ:**
- すべてのデータは`~/.lina-router`(またはカスタム`DATA_DIR`)にローカル保存
- LINA Routerサーバーへのデータ送信なし
- OAuthトークンはJWTで暗号化
