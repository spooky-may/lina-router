...
開発と個人利用のため、ローカルマシンでLINA Routerを実行。

---

## 📦 インストール

npm経由でLINA Routerをグローバルインストール:
...
LINA Routerが実行されているターミナルで `Ctrl+C` を押します。

```bash
# lina-routerを実行しているターミナル
^C  # Ctrl+Cを押す
```
