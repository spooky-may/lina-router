...
Integrate LINA Router with Cline VSCode extension to route your AI requests through LINA Router's intelligent routing system.
...
Set the base URL to your LINA Router endpoint:

**For Local LINA Router:**
```
http://localhost:20128/v1
```

**For Cloud LINA Router:**
```
https://lina-router.com
```

**Steps:**
1. In the **Base URL** field, enter your LINA Router endpoint
...
1. In the **Model** dropdown, you can either:
   ...
   - Manually enter the model name from your LINA Router configuration
...
4. Cline will use LINA Router to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using LINA Router
...
3. Get AI-powered explanations through LINA Router

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use LINA Router to understand context and make changes
...
2. Verify your LINA Router instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check LINA Router logs for any errors
...
2. Make sure you have configured your API key in the LINA Router cloud dashboard
...
## Integration with LINA Router Features

### Model Routing

LINA Router automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, LINA Router automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through LINA Router dashboard:
- Total requests
- Token usage
- Cost per model
