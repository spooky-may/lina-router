...
Integrate LINA Router with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- LINA Router API key from [dashboard](https://lina-router.com/dashboard)
- LINA Router running (local or cloud)
...
### 2. Add LINA Router Model Configuration
...
3. Choose your preferred LINA Router model
...
- Check network latency to LINA Router
